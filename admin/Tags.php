...
<div class="card-box pb-10">
	<div class="h5 pd-20 mb-0 table_head">
		...
		<!-- ********************************** -->
			<!-- Add Admin Button -->
			<button type="button" class="btn btn-primary add-admin-btn" data-toggle="modal"
				data-target="#TagsFormModal_1">
				Add Tag
			</button>

			<!-- Modal Structure -->
			<div class="modal fade" id="TagsFormModal_1" tabindex="-1" role="dialog"
							...
							<form>
								<div class="form-row">
									<div class="col-md-4 mb-3">
										<label for="validationDefault01">First name:ahmad</label>
...
<div class="card-box pb-10">
	<div class="h5 pd-20 mb-0 table_head">
		...
		<!-- ********************************** -->
			<!-- Add Admin Button -->
			<button type="button" class="btn btn-primary add-admin-btn" data-toggle="modal"
				data-target="#TagsFormModal_2">
				Add Tag
			</button>

			<!-- Modal Structure -->
			<div class="modal fade" id="TagsFormModal_2" tabindex="-1" role="dialog"
				aria-labelledby="adminFormModalLabel" aria-hidden="true">
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						<div class="modal-header">
