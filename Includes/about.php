<!-- <h1 class="about">About US</h1><br>
    <div class="aboutus" id="about">
        <h1 class="a">Shoes Haven</h1><br>
        <h2 class="a">An e-commerce website specializing in selling shoes for men, women, and children, keeping up with the latest fashion trends for all seasons. Our website boasts a unique tag-based search system that distingushes us from the rest </h2>
    </div> -->
